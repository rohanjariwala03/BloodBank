<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Blood_Bank.admin.WebForm1" %>
      ...
      <div class="contents-inner">
        <div class="row">
          ...
          <%--<div class="col-12">
            <div class="section-content">
              <div class="content-head">
                <h4 class="content-title">Basic Editable Table</h4><!-- /.content-title -->
              ...
              <div class="content-details show">
                <table id="mainTable" class="table data-table editable-table table-bordered table-striped m-b-3">
                  <thead>
                    <tr>
                      <th>Name</th>
                      <th>Cost</th>
            ...
            <div class="section-content">
              <div class="content-head">
                <h4 class="content-title">Table stripped</h4><!-- /.content-title -->
                <div class="corner-content float-right">
          ...
          <div class="col-12">
            <div class="section-content">
              <div class="content-head">
                <h4 class="content-title">Editable Datatable</h4><!-- /.content-title -->
                <div class="corner-content float-right">
                  <button class="content-settings" data-toggle="tooltip" data-placement="top" title="Settings"><i class="fa fa-cog"></i></button>
                  <button class="content-refresh" data-toggle="tooltip" data-placement="top" title="Reload"><i class="fa fa-refresh"></i></button>
                  <button class="content-collapse" data-toggle="tooltip" data-placement="top" title="Collapse"><i class="fa fa-angle-down"></i></button>
